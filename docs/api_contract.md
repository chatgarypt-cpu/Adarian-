...
Finds the first completed world with `simulation_dataset.json`, builds a Phase 4 JSON report, and stores it under the batch directory. If no dataset exists, returns `409 REPORT_SOURCE_NOT_FOUND`.
