# Adarian Workflow Core Compact v4.0 R0.1 Candidate

> 文档类型：workflow_core_compact.md / 人读运行小抄  
> 当前状态：R0.1 candidate / not repository-landed  
...
若本文件与 `workflow_core.md` 冲突，永远以 `workflow_core.md` 为准。若当前可见 workflow_core.md 仍是 draft / snapshot，只能按过渡期口径使用，不得误判为已正式落盘。
