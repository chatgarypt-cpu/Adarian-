# Control Agent-specific Instruction v4.0 R0.3 Final Candidate
...
若本文件与 workflow_core.md 冲突，以 workflow_core.md 为准。若 workflow_core.md、compact、Agent-specific instruction 三者冲突，HOLD，回 Owner-Control 做权威源对齐。若当前可见 workflow_core.md 仍是 draft / snapshot，则必须按过渡期口径处理，不得当成已正式落盘权威源。
