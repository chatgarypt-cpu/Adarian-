...
from adarian.schemas import EntityExtractionOutput
...
from adarian.whitebox.phase1_reporter import Phase1Reporter
...
def extract_entities_with_validation(
    ...
    for attempt in range(MAX_RETRIES):
        ...
        try:
            ...
            from adarian.phase1.repair_agent import repair_with_agent
...
if __name__ == "__main__":
    ...
    # 检查是否提供了种子文件路径
    if len(sys.argv) < 2:
        seed_file = Path(__file__).parent.parent.parent / "seeds" / "example_event.txt"
