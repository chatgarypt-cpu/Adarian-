...
> 权威来源：`WorkflowBase/governance/memory_registry.yaml`
...
归档文件将写入：
  WorkflowBase/governance/cleaned/<YYYY-MM-DD>/
...
1. **创建 cleaned 目录**：`WorkflowBase/governance/cleaned/<YYYY-MM-DD>/`
...
已归档到: WorkflowBase/governance/cleaned/<YYYY-MM-DD>/
```
